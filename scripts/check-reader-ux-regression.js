...
const cases = [
  ...
  ['missing index entry', 'docs/appendices/figure-index/index.md', function (text) { return text.replace('href="../../chapters/chapter-05/#figure-ch05-order-flow"', 'href="../../chapters/chapter-05/"'); }],
  ...
  ['mixed-quote double href resource', 'docs/assets/images/figures/ch05-order-flow.svg', function (text) { return text.replace('</svg>', "<use href=\"other's.svg#shape\"/></svg>"); }],
  ['mixed-quote single href resource', 'docs/assets/images/figures/ch05-order-flow.svg', function (text) { return text.replace('</svg>', "<use href='other\"s.svg#shape'/></svg>"); }],
  ['mixed-quote xlink href resource', 'docs/assets/images/figures/ch05-order-flow.svg', function (text) { return text.replace(/<svg\b/, '<svg xmlns:xlink="http://www.w3.org/1999/xlink"').replace('</svg>', "<use xlink:href=\"other's.svg#shape\"/></svg>"); }],
  ['namespaced internal xlink fragment', 'docs/assets/images/figures/ch05-order-flow.svg', function (text) { return text.replace(/<svg\b/, '<svg xmlns:xlink="http://www.w3.org/1999/xlink"').replace('</svg>', '<defs><g id="reader-ux-shape"/></defs><use xlink:href="#reader-ux-shape"/></svg>'); }, 0],
  ...
  ['quoted relative CSS SVG resource', 'docs/assets/images/figures/ch05-order-flow.svg', function (text) { return text.replace('</svg>', "<rect fill=\"url('other.svg#paint')\"/></svg>"); }],
  ['absolute CSS SVG resource', 'docs/assets/images/figures/ch05-order-flow.svg', function (text) { return text.replace('</svg>', '<rect fill="url(https://example.invalid/paint.svg#paint)"/></svg>'); }],
  ...
  ['mutable MiniShop snapshot', 'docs/appendices/templates/index.md', function (text) { return text.replace(/tree\/[0-9a-f]{40}\/examples\/minishop/, 'tree/main/examples/minishop'); }],
